...
const AppTopbar = forwardRef((props, ref) => {
  ...
  return (
    <div className="layout-topbar bg-white border-b border-slate-100 shadow-[0_4px_20px_rgba(0,0,0,0.02)] flex items-center justify-between px-6 h-20 relative z-50">
