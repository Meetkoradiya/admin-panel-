      ...
      <div className="flex flex-col items-center mb-8 animate-fade-in">
        <div className="flex items-center gap-3 mb-2">
          <div className="relative">
            ...
            >
              <defs>
                <linearGradient id="logo-grad-new-pass" x1="2" y1="2" x2="22" y2="22" gradientUnits="userSpaceOnUse">
                  <stop offset="0%" stopColor="#3b82f6" />
                  <stop offset="100%" stopColor="#1d4ed8" />
                </linearGradient>
              </defs>
              <circle cx="12" cy="13" r="9" stroke="url(#logo-grad-new-pass)" strokeWidth="0.5" strokeDasharray="4 2" opacity="0.4" />
              <path
                d="M12 3C12 3 6 10 6 14.5C6 18.0899 8.68629 21 12 21C15.3137 21 18 18.0899 18 14.5C18 10 12 3 12 3Z"
                fill="url(#logo-grad-new-pass)"
              />
              <path
