  ...
  return (
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5">
        {cards.map((card, idx) => (
          <div
            key={idx}
            className={`relative flex items-center gap-4 rounded-xl border-t-4 ${card.border} bg-white p-5 shadow-md transition ${
              idx === 0
          ...
          >
            <div
              className={`absolute top-9 right-0 h-12.5 w-17.5 ${card.accent}`}
            >
              <card.Bg />
            </div>
            <div className={`rounded-full bg-gray-100 p-2 text-blue-600`}>
